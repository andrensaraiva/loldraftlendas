...
- A produção do `catalog-v2` foi autorizada para todas as 345 identidades visuais do arquivo; os lotes 01–02 elevaram a cobertura para 50 identidades aprovadas, com checkpoints incrementais planejados até a conclusão.
